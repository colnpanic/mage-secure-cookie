...
/**
 * Mage core pagecache cookie overwrite to secure the frontend cookie when FPC is used
 */
class Etailer_SecureCookie_Model_PageCache_Cookie extends Enterprise_PageCache_Model_Cookie 
{
